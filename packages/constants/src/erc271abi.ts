export const erc721abi = [
  ...
  {
    inputs: [{ internalType: "uint256", name: "_maxPerMint", type: "uint256" }],
    name: "setMaxPerMint",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  ...
  },
  {
    inputs: [
      ...
      { internalType: "uint256", name: "payoutPercent", type: "uint256" },
    ],
